...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden relative">
      {/* Mouse Follower */}
      <div
        className="fixed w-6 h-6 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full pointer-events-none z-50 opacity-50 blur-sm transition-all duration-75"
        style={{
      ...
      <div className="relative z-10 min-h-screen flex items-center">
        <div className="container mx-auto px-6 lg:px-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  ...
                  className="group relative px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl font-semibold text-white overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/25"
                >
                ...
                <a
                  href="https://drive.google.com/file/d/1PdszniG6Lu64Rt0wZiuFXeUG6D4gBF_S/view?usp=sharing"
                  className="group relative px-8 py-4 border-2 border-purple-500 rounded-xl font-semibold text-purple-400 overflow-hidden transition-all duration-300 hover:scale-105 hover:text-white"
                  target="_blank"
                >
            ...
            {/* Right Content - Profile Image & Social Icons */}
            <div className="relative flex justify-center items-center">
              {/* Central Profile Area */}
              <div className="relative">
                {/* Profile Image */}
                <div className="relative w-92 h-92 rounded-full overflow-hidden border-4 border-gradient-to-r from-purple-400 to-pink-400 shadow-2xl">
                  <div className="w-full h-full bg-gradient-to-br from-purple-400/20 to-pink-400/20 flex items-center justify-center text-9xl">
                    👨‍💻
                  </div>
                  ...
                  return (
                    ...
                    >
                      <a
                        ...
                        className="relative w-16 h-16 flex items-center justify-center rounded-2xl backdrop-blur-sm border border-white/20 transition-all duration-300 hover:border-white/40 group"
                      >
                        {/* Hover Tooltip */}
                        {hoveredIcon === index && (
                          <div className="absolute -top-12 left-1/2 -translate-x-1/2 px-3 py-1 bg-black/80 backdrop-blur-sm rounded-lg text-xs font-medium whitespace-nowrap border border-white/20">
                            {social.name}
